...
public abstract class DroppingTablesBaseTest {
    ...
    private static String driverConnectionString = "jdbc:snowflake://" + System.getenv("SNOWFLAKE_TEST_ACCOUNT") + ".snowflakecomputing.com/?" +
    ...
    protected static SessionFactory initSessionFactory() {
        ...
        if (tableType == TableType.HYBRID) {
            ...
            // [09:51:13.983] [DEBUG] [org.hibernate.SQL.logStatement(135)] - insert into employee2 (firstName,lastName,id) values (?,?,?)
            // [09:51:14.210] [DEBUG] [org.hibernate.SQL.logStatement(135)] - insert into employee2 (firstName,lastName,id) values (?,?,?)
            // [09:51:14.210] [DEBUG] [org.hibernate.SQL.logStatement(135)] - insert into employee2 (firstName,lastName,id) values (?,?,?)
            // [09:51:14.787] [WARN ] [org.hibernate.orm.jdbc.checkRowCounts(312)] - HHH100001: JDBC driver did not return the expected number of row counts (employee2) - expected 1, but received 3
    ...
    protected static Connection getDriverRawConnection() throws SQLException {
        ...
        return DriverManager.getDriver(driverConnectionString).connect(driverConnectionString, properties);
    }
