...
class ChildEntityWithLocalIdBiDirectionalOneToOne extends AbstractPerfEntity {
    ...
    public static ChildEntityWithLocalIdBiDirectionalOneToOne sample(PerfOneToOneBiDirectional parent) {
        ChildEntityWithLocalIdBiDirectionalOneToOne sample = new ChildEntityWithLocalIdBiDirectionalOneToOne();
