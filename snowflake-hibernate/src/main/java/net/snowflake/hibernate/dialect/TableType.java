...
public enum TableType {
  ...
  STANDARD(null),
  /**
   * Hybrid table type that is optimized for hybrid transactional and operational workloads that require low
   * latency and high throughput on small random point reads and writes.
   *
   * @see <a href="https://docs.snowflake.com/en/user-guide/tables-hybrid">Snowflake documentation</a>
   */
  HYBRID("HYBRID");
